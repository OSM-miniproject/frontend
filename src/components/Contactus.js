...
const ContactUs = () => {
  ...
  return (
        ...
        <div className="mt-12">
          ...
          <ul className="mt-4">
            <li className="flex items-center">
              ...
              <a href="mailto:kulkarniom7057@gmail.com" aria-label="Send email">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#ff4b2b'
              ...
              <a href="mailto:kulkarniom7057@gmail.com" className="text-[#ff4b2b] text-sm ml-4">
    ...
    className="w-full rounded-md py-3 px-4 bg-gray-100 text-gray-800 text-sm outline-orange-500 focus:bg-transparent"
    />
    <input
    type='email'
    name='email'
    ...
    onChange={handleChange}
    className="w-full rounded-md px-4 bg-gray-100 text-gray-800 text-sm pt-3 outline-orange-500 focus:bg-transparent resize-none"
    />
    <button
    type="submit"
    className="text-white bg-[#ff4b2b] hover:bg-[#FF416C] tracking-wide rounded-md text-sm px-4 py-3 w-full !mt-6"
    >
    Send
    </button>
  </form>
