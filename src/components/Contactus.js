...
const ContactUs = () => {
  ...
  return (
          ...
          <ul className="mt-4">
            <li className="flex items-center">
              ...
              <a href="mailto:kulkarniom7057@gmail.com" aria-label="Send email">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#f97316'
              ...
              <a href="mailto:kulkarniom7057@gmail.com" className="text-[#f97316] text-sm ml-4">
    ...
    onChange={handleChange}
    className="w-full rounded-md px-4 bg-gray-100 text-gray-800 text-sm pt-3 outline-orange-500 focus:bg-transparent"
    />
    <button
    type="submit"
